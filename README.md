# My Custom Hayase Extensions

An independent, custom repository hosting search extensions for the Hayase (formerly Miru) anime torrent player. Built to bypass broken community repositories.
...
## 🛠️ Included Sources
- **Nyaa.si** (Built via local RSS parsing)
